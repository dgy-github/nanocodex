...
pub struct Settings {
    ...
    context_edit_max_history_chars: i64,
    context_edit_max_tool_result_total_chars: i64,
...
fn get_settings() -> Result<Settings, String> {
    ...
    Ok(Settings {
        ...
        context_edit_max_history_chars: cfg.context_edit_max_history_chars,
        context_edit_max_tool_result_total_chars: cfg.context_edit_max_tool_result_total_chars,
        memory_embedding_provider: cfg.memory_embedding_provider.clone(),
        memory_embedding_model: cfg.memory_embedding_model.clone(),
        memory_embedding_base_url: cfg.memory_embedding_base_url.clone(),
        memory_embedding_api_key_env: cfg.memory_embedding_api_key_env.clone(),
        price_in: cfg.price_in,
        price_out: cfg.price_out,
