...
## 当前状态（已完成；上一轮 264 个 Rust 测试全绿，当前源码计 324 个 Rust `#[test]`/`#[tokio::test]` 标记；本机仍需在 cargo 可用环境用 `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\verify-rust.ps1` 复跑）
